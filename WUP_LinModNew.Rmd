...
The value is 0.63. The higher the correlation the closer the points are to each other. This correlation is a bit smaller than the previous correlation between ARM.
